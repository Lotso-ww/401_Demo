...
set_and_check(ids_peak_comfort_c_INCLUDES "${PACKAGE_PREFIX_DIR}/include")
set_and_check(ids_peak_comfort_c_LIBS "${PACKAGE_PREFIX_DIR}/lib/x86_32")
set_and_check(_ids_peak_comfort_c_sharedlib_file 
  "${PACKAGE_PREFIX_DIR}/lib/x86_32/ids_peak_comfort_c.dll"
)
...
file(
  ...
  ${PACKAGE_PREFIX_DIR}/lib/x86_32/*.dll
)

# Set variables and other markers
set(_ids_peak_comfort_c_includes_application_starter FALSE)
...
set(_ids_peak_comfort_c_dotnet_file_dir "${PACKAGE_PREFIX_DIR}/binding/dotnet/x86_32")
...
if(WIN32)
    set_target_properties(ids_peak_comfort_c::ids_peak_comfort_c PROPERTIES
        IMPORTED_IMPLIB_RELEASE "${PACKAGE_PREFIX_DIR}/lib/x86_32/ids_peak_comfort_c.lib"
    )

    list(APPEND _IMPORT_CHECK_FILES_FOR_ids_peak_comfort_c::ids_peak_comfort_c
        "${PACKAGE_PREFIX_DIR}/lib/x86_32/ids_peak_comfort_c.lib" 
    )
endif()
...
##################################################################
# Dotnet
if(_ids_peak_comfort_c_includes_dotnet AND EXISTS "${_ids_peak_comfort_c_dotnet_file_dir}/ids_peak_comfort_c_dotnet.dll")
  ...
  set_and_check(_ids_peak_comfort_c_dotnet_sharedlib_file 
    "${_ids_peak_comfort_c_dotnet_file_dir}/ids_peak_comfort_c_dotnet.dll"
  )
  
  set_and_check(_ids_peak_comfort_c_dotnet_interface_sharedlib_file 
    "${_ids_peak_comfort_c_dotnet_file_dir}/ids_peak_comfort_c_dotnet_interface.dll"
  )
  ...
  file(
    ...
    ${PACKAGE_PREFIX_DIR}/binding/dotnet/x86_32/*.dll
  )
...
function(ids_peak_comfort_c_dotnet_deploy target)
  ...
  if(NOT _ids_peak_comfort_c_includes_dotnet OR NOT EXISTS "${_ids_peak_comfort_c_dotnet_file_dir}/ids_peak_comfort_c_dotnet.dll")
    cmake_policy(POP)
